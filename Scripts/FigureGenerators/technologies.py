...
class FigureController(Controller):
    ...
    ylabel = ""
    directory_name = "Respondents_Technologies.eps"
    question = "Which of the following technologies do you have experience working in?"
    quest_header = "technology_experience"
